...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_get:
        ...
        for func in test_functions_for_get:
            ...
            cond_json = source.find('.json') != -1
            cond_json_loads = source.find('json.loads') != -1
            if cond_json or cond_json_loads:
    ...
    if not test_functions_for_post:
        ...
        if not TEST_FOR_POST_METHOD_RESPONSE_BODY:
            ...
            WARNING_COUNT += 1
            print(
                FAIL_COLOR + "One or more of your test cases for POST() do not seem to be testing \
